"""
Django settings for KLDashboard project.
...
SECRET_KEY = 'g)sjezj3yc4d5xu1#8ulzy0-%o(6tj69o7t3az416e8jd74jt2'
...
ROOT_URLCONF = 'KLDashboard.urls'

WSGI_APPLICATION = 'KLDashboard.wsgi.application'
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR,'KLDashboard/templates'),
)
